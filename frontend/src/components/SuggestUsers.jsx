...
function SuggestedUsers() {
    ...
    return (
        ...
        <div className="w-full h-[43%] mt-5 gap-2 flex flex-wrap  overflow-scroll justify-center">
            {suggestedUsers.map(user => (
                <div key={user.id} className="bg-zinc-800/80 px-4 py-2 gap-2 flex items-center rounded-md w-80 overflow-hidden">
                    <div className='w-[20%]'>
